...
/*--------------------------------- SPI Commands --------------------------- */
#define CMD_REG_READ 		0x00	// with 1-5 Data bytes		R_REGISTER
#define CMD_REG_WRITE 		0x20	// with 1-5 Data bytes		W_REGISTER

#define	CMD_R_RX_PL_WID		0x60	// read RX payload width


#define CMD_RX_READ			0x61	// with 1-32 Data bytes		R_RX_PAYLOAD
#define CMD_TX_WRITE		0xA0	// with 1-32 Data bytes		W_TX_PAYLOAD
#define CMD_TX_FLUSH		0xE1	// 0 data bytes				FLUSH_TX
#define CMD_RX_FLUSH		0xE2	// 0 data bytes				FLUSH_RX
