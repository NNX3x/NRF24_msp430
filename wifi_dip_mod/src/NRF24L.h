...
/* Dummy byte used to pad SPI clock cycles to get more bytes!*/
...
#define REG_RF_SETUP			0x06
	...
	#define RF_DR_LOW				(0 << 5)	// Set RF data rate to 250kbps see rf_dr_high for encoding...bit 3 is hi,5 is low//
	#define RF_DR_250kbps			(2 << 3)	/* Data rate*/
...
/*------------ Address registers ------------*/
#define REG_RX_ADDR_P0			(0x0A)	/* See data sheet for usage, P0 is pipe 0 */
