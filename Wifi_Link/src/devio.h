...
#define DEVIO_P1IN_NRF_IRQ 		(0x01 << 3)
#define DEVIO_P2OUT_NRF_CSN 	(0x01 << 5)
#define DEVIO_P2OUT_NRF_CE 		(0x01 << 2)
...
/* Status LED */
#define DEVIO_P2OUT_STAT_LED 	(0x01 << 1)
